...
namespace BLL.Areas
{
    public class SecurityAreaBs : BaseAreaBs
    {
    ...
    public class LinkHubMembershipProvider : MembershipProvider
    {
        ...
        {
            return UserBs.ValidateUser(username, password);
        }
    ...
    public class LinkHubRoleProvider : RoleProvider
    {
        ...
        {
            return new string[] {UserBs.GetUserRoles(username)};
        }
